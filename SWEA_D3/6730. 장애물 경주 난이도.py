...
sys.stdin = open('6730.txt', 'r', encoding = 'UTF-8')
...
for T in range(int(input())):
    ...
    for b in range(len(blocks)-1):
        if blocks[b+1] - blocks[b] > up:
            up = blocks[b+1] - blocks[b]
        elif blocks[b+1] - blocks[b] <= down:
            down = blocks[b+1] - blocks[b]
    print('#%d %d %d' %(T+1, up, abs(down)))
